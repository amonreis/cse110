...
def make_periodic_table():
    # Write a function named make_periodic_table that takes no parameters
    # and creates and returns a compound dictionary.
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for inner_list in symbol_quantity_list:
        ...
        line = periodic_table_dict[symbol]
        atomic_mass = line[ATOMIC_MASS_INDEX]
